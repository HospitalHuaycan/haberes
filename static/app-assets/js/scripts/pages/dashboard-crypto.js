/*=========================================================================================
    ...
    ----------------------------------------------------------------------------------------
    Item Name: Modern Admin - Clean Bootstrap 04 Dashboard HTML Template
    Version: 1.0
    Author: GeeksLabs
...
(function(window, document, $) {
    ...
    ********************************************/
    ...
    blue_trans_gradient.addColorStop(0, 'rgba(255, 145, 73,0.04)');
    ...
    ********************************************/
    ...
    blue_trans_gradient.addColorStop(0, 'rgba(120, 144, 156,0.04)');
    blue_trans_gradient.addColorStop(1, 'rgba(255,255,255,0)');
    // Chart Options
    var ETHStats = {
        responsive: true,
    ...
    ********************************************/
    ...
    blue_trans_gradient.addColorStop(0, 'rgba(30,159,242,0.04)');
    blue_trans_gradient.addColorStop(1, 'rgba(255,255,255,0)');
    // Chart Options
    var XRPStats = {
        responsive: true,
                ...
                xAxis : [
                    {
                        ...
                        data : [
                            ...
                            "2017/3/28", "2017/3/29", "2017/04/1", "2017/04/2", "2017/04/3",
                            "2017/04/8", "2017/04/9", "2017/04/10", "2017/04/11", "2017/04/12",
                            ...
                            "2017/5/30", "2017/5/31", "2017/6/3", "2017/6/04", "2017/6/5",
