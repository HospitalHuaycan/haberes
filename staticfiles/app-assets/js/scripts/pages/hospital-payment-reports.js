...
var reports = function () {
    ...
    $('#sp-line-weekly-cost').sparkline([14, 12, 4, 9, 3, 6, 11, 10, 13, 9, 14, 11, 16, 20, 15], {
        ...
        width: "100%",
        height: '100px',
        lineColor: 'rgba(255,145,73,0.04)',
        fillColor: 'rgba(255,145,73,0.04)',
        spotColor: '',
        minSpotColor: '',
        maxSpotColor: '',
        highlightSpotColor: '',
    ...
    $('#sp-line-monthly-cost').sparkline([4, 9, 3, 6, 11, 10, 13, 9, 14, 11, 16, 20, 15, 20, 12, 25], {
        ...
        width: "100%",
        height: '100px',
        lineColor: 'rgba(40,208,148,0.04)',
        fillColor: 'rgba(40,208,148,0.04)',
        spotColor: '',
        minSpotColor: '',
        maxSpotColor: '',
        highlightSpotColor: '',
    ...
    $('#sp-line-yearly-cost').sparkline([4, 9, 3, 6, 11, 10, 13, 9, 14, 11, 16, 20, 15, 20, 12, 25], {
        ...
        width: "100%",
        height: '100px',
        lineColor: 'rgba(255,73,97,0.04)',
        fillColor: 'rgba(255,73,97,0.04)',
        spotColor: '',
        minSpotColor: '',
        maxSpotColor: '',
        highlightSpotColor: '',
