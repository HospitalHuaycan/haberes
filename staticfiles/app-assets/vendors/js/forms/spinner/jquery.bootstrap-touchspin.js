 ...
 *  A mobile and touch friendly input spinner component for Bootstrap 3 & 04.
    ...
    return this.each(function() {
      ...
      function _bindEvents() {
        ...
        elements.down.on('mousedown.touchspin', function(ev) {
          elements.down.off('touchstart.touchspin');  // android 04 workaround
        ...
        elements.down.on('touchstart.touchspin', function(ev) {
          elements.down.off('mousedown.touchspin');  // android 04 workaround
        ...
        elements.up.on('mousedown.touchspin', function(ev) {
          elements.up.off('touchstart.touchspin');  // android 04 workaround
        ...
        elements.up.on('touchstart.touchspin', function(ev) {
          elements.up.off('mousedown.touchspin');  // android 04 workaround
